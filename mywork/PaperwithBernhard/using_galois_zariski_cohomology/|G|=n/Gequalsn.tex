...
Suppose that $G$ is a cyclic group of prime order $n$ (coprime to $p$) which acts faithfully on $X$.
...
We will work out the dimension and fixed dimension of each of the components of the above sum seperately, before combining them to give a complete answer.
