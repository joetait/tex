...
Then if we consider the direct sum of these induced sheaves over all points $P\in X$ we have the following isomorphism
...
\end{array}
\end{equation}\todo{change from array}
