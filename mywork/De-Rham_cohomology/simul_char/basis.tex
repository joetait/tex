...
Note that this requires, for any $\sigma$ in the nerve of $\cU$ and any $p \geq 1$, ${\check H}^p(U_\sigma, \cO_X)$ and ${\check H}^p(U_\sigma, \Omega_X)$ to be zero ---\todo{continue from here finish}
