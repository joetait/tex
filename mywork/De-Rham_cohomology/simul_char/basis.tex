...
Hence the kernel of $d_3$ is formed of those differentials which agree on $U_0 \cap U_\infty$.
...
We will show that $\langle x^iy^{-1}dx, yx^{-j} \rangle = \sum_{P \in X}\res_P(x^{i-j}dx)$ is non-zero for $j = i+1$.
