...
As described in the paragraph preceding this lemma, the map $ \langle , \rangle\colon \hzero \cross \hone \ra k$ is a dual map.
We have shown that for $i \in \{0, \ldots, g-1\}$ the product $\langle x^iy^{-1}dx, yx^{-(i+1)}|_{U_0} \rangle \neq 0$, hence forms a dual basis, hence a basis. \todo{finish}
