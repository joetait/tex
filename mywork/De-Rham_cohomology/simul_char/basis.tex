...
If $G$ acts faithfully on $X$ then $G$ also acts faithfully on $\derhamhone$.
...
\todo[inline]{maybe jsut state which divisors are being used once at the start of the computations}
