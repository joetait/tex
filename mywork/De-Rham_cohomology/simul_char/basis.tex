...
0 \rightarrow \cO_X \rightarrow {\cal K}_X \rightarrow {\cal K}_X/\cO_X \rightarrow 0,
\end{equation}
where $\cal K_X$ is the constant sheaf $K(X)$.
In fact, by \cite[Chap II, ex. 1.16]{hart}, we see that this is a flasque resolution of $\cO_X$.

Clearly the sheaf $K_x/\cO_P$ is a sheaf on the singleton $\{P\}$, which has a natural embedding $i\colon \{P\} \rightarrow X$.
...
\[
{\cal K}_X/\cO_X \cong \bigoplus_{P\in X} i_*(K_X/\cO_P).
\]
This can be seen by considering the stalks of both sides, which are clearly isomorphic.
