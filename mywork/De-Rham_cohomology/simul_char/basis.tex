...
\todo[inline]{check usage of equation numbers}
...
\end{equation*}
otherwise.
These equalities follow from \eqref{divyp=2} and \eqref{divxp=2}, and the divisors are clearly positive on $U_0 \cap U_\infty$.
...
We then compute the divisor of $ \frac{y}{x^j} \cdot \frac{x^i}{H(x)}dx$ using \eqref{divxp=2}, \eqref{differentialdivisor}, \eqref{divisorofH} and \eqref{divyp=2}, which is
\begin{align*}
