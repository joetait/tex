...
Then there are unique $\alpha_1, \ldots , \alpha_g \in k$ such that, after $f_P$ is replaced by $f_P - \left( \alpha_1 \frac{y}{x} + \ldots + \alpha_n \frac{y}{x^n} \right)$ for all $P \in \pi^{-1}(\infty)$, there exists an $f \in K(X)$ such the laurent tail of $f$ at each $P$ in $X$ will be $f_P$.
\end{cor}
