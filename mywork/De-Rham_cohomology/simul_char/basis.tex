...
\todo[inline]{changed indices, check that this has not left inconsistencies. In particular, check $f_{12}$}
...
This will not affect the rest of the article, since we will not need to choose between the points at anytime, so the choice is arbitrary.\todo{rephrase}
