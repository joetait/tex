...
In particular, since both $\omega_0$ and $\omega_\infty$ are regular on $U_0 \cap U_\infty$ for all such pairs, so are all elements of $\hzero$.
...
We described in the paragraph preceding this theorem that Serre duality gives us a dual map $\langle, \rangle \colon \hone \times \hzero \ra k$.
