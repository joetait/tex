...
Since $\res_P(\omega)=0$ for all $P \in U_0 \cap U_\infty$, and similarly $\res_P(0)=0$ for all $P \in U_\infty$, then we conclude that 
\[
...
\]
for some $a_i, b_i \in k$, $d_f = \deg(f) $ and $n_i \in  \mathbb N$.
...
If $d_f = 2g+1$ then we let $P_{2g+2} = P_\infty$, and then $P_1, \ldots, P_{2g+2}$ are all the ramification points of $\pi$.
...
\end{equation*}
for some $A_i, B_i \in  k$, ${d_H} \deg(H(x)) \leq g+1$ and $n_i \in \mathbb N$.
