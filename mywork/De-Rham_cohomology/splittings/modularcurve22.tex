...
\begin{align*}
\sigma(\aleph_1) & = (4a^3a_6+a^2a_5+a_3)x^4 + (-16a^4a_6-a^3a_5+2a^2a_4-7aa_3)x^3 \\
& + (24a^5a_6-3a^4a^5-4a^3a_4+21a^2a_3-a_1)x^2 \\
& + (5a^5a_5-16a^a_6+6a^4a_4-13a^3a_3+4a^2a_2+3aa_1-2a_0)x \\
& + a(4a^6a_6-2a^5a_5-2a^4a_4+4a^3a_3+4a^2a_2+4aa_1+4a_0)
\end{align*}
