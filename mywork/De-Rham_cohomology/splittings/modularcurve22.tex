...
\begin{multline*}
\nu_1 = \left(\frac{a_3x^3-a_1x-2a_0}{yx^2}dx, \frac{-(4a_6x^4+3a_5x^3+2a_4x^2)}{2y}dx, \frac{x^4 + 2x^3 +  2x^2}{2y(x-a)^3}dx, \right. \\ \left. \frac{y}{x}, \frac{a^2y}{x(x-a)^2}, \frac{-y(x-2a)}{(x-a)^2} \right)
\end{multline*}
and
\begin{multline*}
\nu_2 = \left( \frac{-(a_3x^3+2a_2x^2+3a_1x+4a_0)}{2yx^3}, \frac{-(2a_6x^3+a_5x^5)}{2y}dx, \frac{x^3 + x^2 + x+ 1}{2y(x-a)^3}dx, \right. \\ \left. \frac{y}{x^2}, \frac{y(a^2-2ax)}{x^2(x-a)^2}, \frac{-y}{(x-a)^2} \right)
\end{multline*}
...
We now check that differentials and functions are regular on the appropriate open sets.
\end{proof}
