...
We begin by computing $df_{0 \sigma i}$, as follows:\tod{add ``$(x)$'' to $r_{ij,}$ and $t_{i,j}$ terms}
\begin{align*}
...
& = \frac{f'r_{i,g} + 2if(xr_{i,g}'(x-a) - i(x-a)r_{i,g} - gxr_{i,g})}{2yx^i(x-a)^g}.
\end{align*}
Now we note that $r_{i,g}' = gr_{i-1, g}$
\end{proof}
