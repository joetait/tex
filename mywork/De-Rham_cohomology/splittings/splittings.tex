...
\begin{multline*}
\left( \frac{2ax^8 + 2a^3x^6 + (2a^4 +aa_6)x^5 + 2a^2a_6x^4 (a^3a_6 + a_3)x^3 + 2a^4a_6x^2 + (a^8 + a^2a_3)x + a^6a_6 +a_0 }{2yx^5}, \frac{x^4 +ax^3 +(a^3+a_6)x + a^4+aa_6}{y}, frac{y}{x^4} \right)
\end{multline*}
