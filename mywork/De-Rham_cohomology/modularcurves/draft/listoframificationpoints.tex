...
& \left( \frac{y}{x^2}, \frac{ay(a-2x}{x^2{x-a}^2},\frac{2ay}{(x-a)^2} \right).
\end{align}
Note that 
\[
...
\begin{equation}
\left(\frac{y}{x^{g-k}}, \frac{y\left( \sum_{i=0}^{g-k} \binom{i}{g-k}a^ix^{g-k-i}\right)}{x^{g-k}(x-a)^4}, \frac{-y\left( \sum_{i=g-k}^g \binom{g}{i} a^{i-(g-k)}x^{(g-k)-i}\right)}{(x-a)^g} \right)
\end{equation}
