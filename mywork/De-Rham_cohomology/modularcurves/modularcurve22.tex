...
The elements of $G= Aut(X)$\todo{make "Aut" an operator} we will be considering will always fix $U_\infty$, so if $\sigma$ is the element we are considering we will need only add $\sigma^{-1}(U_0)$.
