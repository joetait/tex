...
\title{Faithful Action on Spaces of Global Poly-Differentials on an Algebraic Curve \vskip1em 18 Month Report}
\author{J Tait\\ Supervisor: B. K\"ock}
...
We briefly describe an alternative, but equivlant, definition of the ramification divisor, which we will use later.
...
More details can be found in \cite[Ch. IV]{localfields}.\todo{more specific citation}
...
\bibliography{/home/joe/files/tex/Bibliography/biblio}
