...
\vskip1em
  ...
  The strong form of the theorem states that given two curves and a surjective map $\pi\colon X\rightarrow Y$ of degree $n$ between the curves, with ramification divisor $R$ (see Section \ref{Hurwitzsection}), we have
  \[
...
The dimension itself is dependent, essentially, on the genus of the quotient curve, $Y=X/G$, the degree of the projection map $\pi\colon X\rightarrow Y$, the ramification divisor $R$ of $\pi$ and $m$.
