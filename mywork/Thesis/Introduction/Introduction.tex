...
Given a subgroup $G$ of the automorphism group of $X$ then a classic problem pertaining to $H^0(X,\Omega_X)$, the space of holomorphic differentials (see section \ref{Chapter:hurwitzformula}), is determining its $k[G]$-module structure.
...
However, this can obscure the fact that the canonical divisors (see Section \ref{Chapter:hurwitzformula}) themselves are related.
The strong form of the theorem states that given two curves and a surjective map $\pi:X\rightarrow Y$ of degree $n$ between the curves, with ramification divisor $R$ (see Section \ref{Chapter:hurwitzformula}), we have
    \[
