...
\todo[inline]{adjust preceding paragraph}
...
\todo[inline]{check that projection map is used later}
...
Hence the de Rham cohomology of Riemann surfaces\todo{edit this}
...
Theorem \ref{theoremsplittingtheorem}, stated below, generalises this result.
\todo[inline]{explain induced map - finished here}
    \begin{unnumthm}
