...
In this section we prove the main theorem of this chapter, describing exactly when $G$ will act faithfully on $H^0(X,\Omega_X^{\otimes m})$.
    ...
    \begin{rem}
    If $X$ is not hyperelliptic we can give a short proof of the ``only-if" direction of Theorem \ref{theoremfaithfulaction} when $m = 1$ using \cite[Chap.\ IV, Prop.\ 5.2]{hart}.
