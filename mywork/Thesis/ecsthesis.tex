...
\authors    {\texorpdfstring
             {\href{mailto:Joe.Tait@ecs.soton.ac.uk}{Joseph J. Tait}}
             {Joseph J. Tait}
            }
...
\listofsymbols{ll}{ 
                    ...
                    $\cA_X$                 & Space of \adele s on $X$ \\
                    $\cA_X(D)$              & Space of \adele s associated to $D$ \\
                    $\cA_{X/Y}$             & See pg.\ 13 \\
...
\include{./valentinimadan/valandmad}
