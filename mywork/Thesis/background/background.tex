...
We say that $\omega \in \Omega_{K(X)}$ is a \emph{meromorphic differential}\index{Differential!meromorphic} on $X$.
...
We call $\omega \in \Omega_{K(X)}$ \emph{holomorphic on $U$}\index{Differential!holomorphic!on $U$} if $\ord_P(\omega) \geq 0$ for all $P \in U$, and we let
    ...
    \]
be \emph{the space of holomorphic differentials on $U$}\index{Differential!holomorphic!space of}.
If $\omega \in \Omega_{K(X)}$ is holomorphic on $X$ we say that $\omega$ is \emph{holomorphic}\index{Differential!holomorphic}, and so $\hzero$ is the space of global holomorphic differentials.
...
The \emph{degree}\index{Degree!of divisor} of the divisor $D$ is $\deg(D) := \sum_{P \in X} n_P$, which lies in $\ZZ$.
...
We then define the \emph{degree}\index{Degree!of morphism} of $\phi$, denoted $\deg(\phi)$, to be the degree of the extension $K(X)/K(Y)$, which is always finite.
