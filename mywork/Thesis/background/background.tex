...
We will use these descriptions almost exclusively for the rest of the thesis, and as such the reader may take as their definition if he or she wishes.
    ...
    These adjunction maps give a map $\underline{K(X)}/\cO_X \ra \prod_{P \in X}\left( K(X)/\cO_{X,P} \right)$, whose image is actually in the sum $\oplus_{P \in X} i_*\left(K(X)/\cO_{X,P} \right)$.
