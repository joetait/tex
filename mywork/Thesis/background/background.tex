...
All definitions and results should be available in elementary texts on algebraic curves or algebraic geometry in general, such as \cite{hart}, \cite{fulton} or \cite{griffithsfirstcourse}.
