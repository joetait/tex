...
%    \end{rem}
    ...
    Then it follows that for all $\alpha \in \hone$ then
        ...
        \end{equation}
    We will show that this equality gives rise to a contradiction when $\alpha$ is the residue class of $\frac{y}{x^g}|_{U_0 \cap U_\infty}$ in $\hone$ (see \todo{find references - $\hone$ isomorphism } and Theorem \ref{basish1}).  
...
%        \]
%    used in the proof of Proposition \ref{basis22}.
    Then 
        \begin{align*}
