...
By an automorphism of $ \mathbb P_k^1$ we may assume that $P_0$ and $P_\infty$ are ramification points.
...
~ & ~ & \downarrow & ~ & \downarrow & ~ & ~ \\
0 & \rightarrow & \cO_X(U_1 \cap U_2) & \rightarrow & \cO_X(U_1 \cap U_2) & \rightarrow & 0 \\
~ & ~ & \downarrow & ~ & \downarrow & ~ & ~ \\
~ & ~ & 0 & \rightarrow & 0 & ~ & ~ \\
\end{array}
\]
