...
\end{eqnarray*}
Finally, to define the ramification divisor we suppose that \todo{check this notation doesn't clash with anything else}{$h = \prod_{i=1}^d (x-a_i)^{n_i}$} for some $d \leq g$.
