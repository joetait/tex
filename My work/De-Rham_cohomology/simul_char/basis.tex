...
It is clear that \eqref{two} and \eqref{four} is an element of \eqref{derhamconditions}, and it follows from \cite[Thm 6.1]{faithfulaction} that they are the image of the basis of $H^0(X,\Omega_X)$ in $\derhamhone$.\todo{more accurate citation}
...
\begin{align*}
\left(  \frac{\psi_i}{2yx^i}  - \frac{-\phi_i}{2yx^i} \right) dx & =  \frac{s_i}{2yx^i} dx \\
