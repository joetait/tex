...
Then any group $G$ acting on $X$ acts faithfully on $H^1_{dR}(X/k)$, the first algebraic de Rham cohomology group of $X$.
...
We see from the above proposition that the third entry in the basis of $H^1(X,\cO_X)$ given by \cech cohomology is $x^{-i}y$ for $1 \leq i \leq g$.
