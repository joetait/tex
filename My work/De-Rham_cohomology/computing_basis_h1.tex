...
We may also assume that $f(x) = x^{2g+1} + a_{2g}x^{2g} + \ldots + a_0$ for some $a_i \in k$.
...
{\bf Note - this assumes that the coefficient of $P_0$ and $P_\infty$ in $R$ is one - this may be done via an automorphism?}
