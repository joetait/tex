...
{\bf Note - this assumes that the coefficient of $P_0$ and $P_\infty$ in $R$ is one - this can be done via an automorphism?}
...
This is because the residue of $\frac{1}{x}dx$ is the coefficient of $t^{-1}$ in $\frac{2x^{2g+1}}{h(x)}\cdot t$, whihc is coefficient of $t^{-2}$ in $\frac{2x^{2g+1}}{h(x)}$.
...
Hence we can easily derive $c_6 = \frac{2\cdot a_{2g-1} \cdot a_{2g+1} - 2a_{2g}^2}{a_{2g+1}^4}$, from equations $(7)$ and $(4)$ above.
