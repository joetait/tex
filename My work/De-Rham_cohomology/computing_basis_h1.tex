...
Since $\frac{h}{x^{2g+1}} \cdot \frac{x^{2g+1}}{h} = \left( \sum_{i\geq 2} c_it^i\right) \cdot \left( \sum_{i\geq -2} d_it^i\right) = 1$ we conclude that $d_{-2} = 1$.\todo{need some large brackets}
Now 
\[
