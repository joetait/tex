...
We wish to compute a basis for the first de-Rham hypercohomology of this curve, which we denote by \todo{$H^1_{dR}(X/k)$.}{define this} \todo{check notation - currently copied from Hortsch paper}
...
\todo{just sum over $U_1$ and not the whole of $X$?}This is defined by  $(\omega,f) \rightarrow \sum_{P\in X}\text{res}_P(f\omega)$ for some $(\omega, f) \in   H^0(X,\Omega_X) \times H^1(X,\cO_X)$.
