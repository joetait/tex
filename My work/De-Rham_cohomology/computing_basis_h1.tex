...
Indeed, $ydx^{-i}$ has a zero of order one at each ramification point.
Since $dy = \frac{f'}{2y}dx$, so $x^{-i}dy$ has a zero of order at each zero of $f'$ and a pole of order one at each $y$.
